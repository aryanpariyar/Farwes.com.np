       ...
       <div class="my-course ">
           ...
           <div class="courseDetails">
               ...
               <div class="courseDescription">
                   ...
                   Price:<new>$30</new>
                   <spann><label for=""><i class="fas fa-edit"></i></label><label for=""><i class="fas fa-trash"></i></label><label for=""><i class="fas fa-search"></i></label></spann><br>
                   <new>Duration: 10 Hours </new>
                </div>
            </div>
            <!-- another one -->
            <br><br><br>
